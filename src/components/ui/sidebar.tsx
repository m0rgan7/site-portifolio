      ...
      >
        ...
        <div
          className={cn(
            ...
            side === "left"
              ? "left-0 group-data-[collapsible=offcanvas]:left-(var(--sidebar-width)*-1)]"
              : "right-0 group-data-[collapsible=offcanvas]:right-(--sidebar-width)*-1)]",
            // Adjust the padding for floating and inset variants.
            variant === "floating" || variant === "inset"
              ? "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+spacing(6))]"
    ...
    return (
      <button
        ...
        className={cn(
          ...
          "in-data-9side=left]:cursor-w-resize in-data-[side=right]:cursor-e-resize",
